import axios, { AxiosInstance, AxiosRequestConfig, AxiosRequestHeaders, AxiosResponse, AxiosResponseTransformer } from 'axios';

export default class HttpClient {
    // Here you can use your server URL
    private static readonly baseURL: string = process.env.REACT_APP_API_BASEURL;
    // private static readonly baseURL: string = process.env.REACT_APP_API_BASEURL || 'http://localhost:3000'
